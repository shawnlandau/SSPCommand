...
export default function ActionBar({
  ...
  return (
    <div className={`sticky bottom-4 z-30 ${className}`}>
      <div className="bg-card/80 backdrop-blur-xl border border-border rounded-2xl shadow-medium p-4">
        <div className="flex items-center gap-3">
            ...
            <form onSubmit={handleSearch} className="flex-1 max-w-md">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 bg-neutral-50 border border-border rounded-xl focus:outline-none focus:ring-2 focus:ring-accent-500 focus:border-transparent transition-all duration-200"
                />
                {searchQuery && (
                  <button
                    type="button"
          ...
          <div className="flex items-center gap-2 ml-auto">
            <button
              ...
              className={`p-2.5 rounded-xl transition-colors duration-200 ${
                showFilters 
                  ...
                  : 'bg-neutral-100 text-foreground-muted hover:bg-neutral-200 hover:text-foreground'
              }`}
            >
            ...
            {onExport && (
              <button
                onClick={onExport}
                className="p-2.5 bg-neutral-100 text-foreground-muted rounded-xl hover:bg-neutral-200 hover:text-foreground transition-colors duration-200"
                title="Export Data"
              >
